...
function random_noise3D(x, y, z, frequency, amplitude) {
  ...
  return amplitude * noise.noise3D(
    x * frequency,
    y * frequency,
    z * frequency
  );
...
class SimplexNoise {
  ...
  //       case 4:
  //         this.fResult += fPers * noise4D(fFreq * x, fFreq * y, fFreq * z, fFreq * w);
  //         break;
  //       case 3:
  //         this.fResult += this.fPers * this.noise3D(this.fFreq * x, fFreq * y, fFreq * z);
  //         break;
  //       default:
  //         this.fResult += fPers * noise2D(fFreq * x, fFreq * y);
  //     }
  //   }
